var translations = {
    ...
    sk: {
        ...
        aboutTitle: "O mne",
        aboutText1: 'Ahoj, volám sa <strong>Sam</strong> — webový vývojár samouk zo <strong>Slovenska</strong>, mám <span id="age">…</span> rokov. Vytváram <strong>rozšírenia pre prehliadače</strong>, <strong>používateľské skripty</strong> a malé nástroje, vďaka ktorým sa platformy ako <a href="https://www.twitch.tv" target="_blank" rel="noopener">Twitch</a>, <a href="https://x.com" target="_blank" rel="noopener">X</a> a <a href="https://betterdiscord.app" target="_blank" rel="noopener">BetterDiscord</a> stávajú príjemnejšie na používanie.',
